/*
PLEASE DO NOT EDIT THIS FILE WITHOUT HELP FROM THE DEVELOPER
PLEASE DO NOT EDIT THIS FILE WITHOUT HELP FROM THE DEVELOPER
PLEASE DO NOT EDIT THIS FILE WITHOUT HELP FROM THE DEVELOPER
*/
var resname;
...
function ClosePanel()
{
    var obj = { message: 'Panel is closing, Please wait!!'};
    $.post('http://'+resname+'/ClosePanel', JSON.stringify(obj));
}

function RefreshPanel()
{
    var obj = { message: 'Panel is refreshing, Please wait!!'};
